...
const menuCategories = [
  {
    ...
    items: [
      ...
      { label: 'Contador', href: '/counter', icon: 'counter' },
    ],
  },
  {
    label: 'Moderacao',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Sugestoes', href: '/suggestions', icon: 'suggestion' },
    ],
  },
  {
    label: 'Interacoes',
...
const iconPaths: Record<string, string> = {
  ...
  counter: 'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75M9 7a4 4 0 1 0 0 8 4 4 0 0 0 0-8z',
  ...
  suggestion: 'M9 21h6M12 17v4M12 3a9 9 0 0 0-9 9c0 2.4 1.2 4.5 3 5.7V21h12v-3.3c1.8-1.2 3-3.3 3-5.7a9 9 0 0 0-9-9z',
  emoji:
