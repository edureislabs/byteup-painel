...
export default async function DashboardPage() {
  ...
  return (
    <main style={{ padding: "2rem", fontFamily: "'DM Sans', sans-serif", color: "#dbdee1", background: "#0e0f11", minHeight: "100vh" }}>
      <div style={{ maxWidth: "600px", margin: "0 auto" }}>
        <h1 style={{ color: "#f2f3f5", fontSize: "24px", fontWeight: 600, marginBottom: "24px" }}>Seus Servidores</h1>
